const createNav = () => {
    ...
    <style>@import 'css/nav.css';</style>
        <div class="nav">
            <img src="img/dark-logo.png" href="home.html" style="width: 25%; class="brand-logo" alt="">
            <div class="nav-items">
                <div class="search">
                ...
                <a href="cart.html" class="addToCart"><img src="img/cart.png" alt="">
                    <span id="addTo">0</span>
                </a>
